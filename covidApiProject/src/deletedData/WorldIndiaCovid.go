...
func getIndiaStatesdCovidDetails(w http.ResponseWriter, r *http.Request) {
	...
	webPageStates, err := template.ParseFiles("C:\\Users\\SRS\\gitProject16april\\golang_Practicing\\covidApiProject\\html\\statesCovidDetails.html")
	if err != nil {
		log.Fatal(err)
	}
...
func handlerMethod() {
	...
	http.HandleFunc("/get/", getIndiaStatesdCovidDetails)
